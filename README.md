...
| :--- | :--- | :--- |
| **Juan Andrés Isaza** | **Líder de Repositorio** (Ramas `main`, `develop`, `release`) | Estructura inicial, menú base, opción de **Agregar** contacto. Gestión de integración. |
| **Gian Franco Piedrahita** | **Desarrollador Feature** (Rama `feature/listar`) | Creación del modelo `Contacto` y lógica de la opción de **Listar** contactos. |
